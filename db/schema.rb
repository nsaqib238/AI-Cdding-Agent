...
ActiveRecord::Schema[7.2].define(version: 2026_05_01_111936) do
  ...
  create_table "agent_tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conversation_id"], name: "index_agent_tasks_on_conversation_id"
  end

  create_table "coding_files", force: :cascade do |t|
    t.bigint "project_id"
    ...
    t.index ["project_id", "relative_path"], name: "index_coding_files_on_project_id_and_relative_path", unique: true
    t.index ["project_id"], name: "index_coding_files_on_project_id"
  end

  create_table "coding_projects", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["absolute_path"], name: "index_coding_projects_on_absolute_path", unique: true
  end

  create_table "command_executions", force: :cascade do |t|
    t.bigint "conversation_id"
    t.text "command"
    t.text "output"
    t.integer "exit_code"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conversation_id"], name: "index_command_executions_on_conversation_id"
  end
